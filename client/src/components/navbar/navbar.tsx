...
<nav className="bg-white border-gray-200 dark:bg-gray-900">
  ...
  <a href="#" className="flex items-center">
      <img src="https://res.cloudinary.com/dk4darniv/image/upload/v1697793048/pdf%20logos/_-xSnrXjfDZJcIr_I25vYF8GkZI0uW6p_gm7pmb.webp" className="h-8 mr-3" alt="Logo" />
      <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">PDF Extractor</span>
  </a>
  <div className="flex items-center md:order-2">
      <button type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
        <span className="sr-only">Open user menu</span>
        <img className="w-8 h-8 rounded-full object-cover" src="https://res.cloudinary.com/dk4darniv/image/upload/v1690396460/png-transparent-circle-silhouett_pfuxe9.webp" alt="user photo"/>
      </button>
